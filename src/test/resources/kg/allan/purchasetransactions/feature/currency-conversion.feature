Feature: Currency Conversion
	...
	Scenario: Convert an amount with a specific transaction date that there is no conversion rate for that day
		...
		And the stored transaction date is <date>
	  ...
	  Examples:
		|currency|date      |value|converted|rate_date |
		|BRL     |2023-07-01|715  |3473.47  |2023-06-30|
	...
	Scenario: Return an error value when the conversion is not possible
	  ...
	  Examples:
		|currency|date      |value|mindate   |converted|
		|CUP     |2019-12-30|20   |2019-06-30|3473.47  |
		# CUP - Cuba
	...
	Scenario: Convert an amount to the conversion rate of the same day as the transaction
	  ...
	  Examples:
		|currency|date      |value|converted|rate_date |
		|BRL     |2023-06-30|1599 |7767.94  |2023-06-30|
